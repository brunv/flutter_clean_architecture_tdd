...
// we can utilize them by building a UI through, we have to connect them
// together. Since every class is decoupled from its dependencies by accepting
// them through the constructor, we shomehow have to pass them in.

// We've been doing this all along in test with the mocked classes. Now,
...
// singletons. They are very close to the UI and if your app has multiple pages
// between which you navigate, you probably want to do some cleanup (like
// closing Streams of a Bloc) from the dispose() method of a StatefulWidget.
//
